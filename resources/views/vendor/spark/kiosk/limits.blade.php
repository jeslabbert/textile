<div class="card card-default mb-12">
    <div class="card-header">
        <h2 class="card-title mb-0">{{__('Default Plan Limits')}}
            <a class="btn btn-sm btn-primary pull-right" data-toggle="collapse" href="#collapseDefaultPlan" role="button" aria-expanded="false" aria-controls="collapseDefaultPlan">
                +
            </a>
        </h2>
    </div>
    <div class="card-body collapse" id="collapseDefaultPlan">
