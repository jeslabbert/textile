<form role="form">
    ...
    <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" name="last_name" v-model="registerForm.last_name" :class="{'is-invalid': registerForm.errors.has('last_name')}" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" name="username" v-model="registerForm.username" :class="{'is-invalid': registerForm.errors.has('username')}" autofocus>
